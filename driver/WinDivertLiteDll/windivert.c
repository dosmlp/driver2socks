...
#define WINDIVERT_DRIVER_NAME           L"WinDivertLite"
#define WINDIVERT_DRIVER32_SYS          L"\\" WINDIVERT_DRIVER_NAME L".sys"
#define WINDIVERT_DRIVER64_SYS          L"\\" WINDIVERT_DRIVER_NAME L".sys"
    ...
    UINT64 flags)
{
    ...
    /*
    if (sizeof(WINDIVERT_ADDRESS) != 112 ||
